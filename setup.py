...
setup(
    ...
    version=
    '0.3',  # Start with a small number and increase it with every change you make
    license=
    'MIT',  # Chose a license from here: https://help.github.com/articles/licensing-a-repository
    description=
    'A small Parser and Interpreter for the Educational WHILE - Programming Language by Uwe Schoening.',  # Give a short description about your library
    ...
    download_url=
    'https://github.com/ricffb/while-lang/archive/refs/tags/v0.3.tar.gz',  # I explain this later on
