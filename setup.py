...
setup(
    ...
    version=
    '0.2',  # Start with a small number and increase it with every change you make
    license=
    ...
    download_url=
    'https://github.com/ricffb/while-lang/archive/refs/tags/v0.2.tar.gz',  # I explain this later on
